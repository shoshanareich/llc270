...
ln -sf /nobackup/sreich/llc270_c68w_runs/run_template/ones32.bin .
ln -sf /nobackup/sreich/llc270_c68w_runs/run_template/ones64.bin .
#ln -sf /nobackup/sreich/swot/swot_obsfit_L3/swot_cycles_009_010_llc270_obsfit.nc . 
...
#--- 7. executable --------
cp -f ${builddir}/mitgcmuv_ad ./mitgcmuv_ad
